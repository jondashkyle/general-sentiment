...
const APP_ICONS = {
  ...
  "word tree":
    '<svg width="128" height="128" viewBox="0 0 128 128" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M30.2264 32.1757C29.6824 31.3584 29.5504 37.4987 30.968 53.5348C32.9027 75.4198 37.1283 92.3919 40.8479 90.698C47.5068 87.6656 51.8198 66.9393 55.9026 58.4252C59.9855 49.9111 60.6313 50.8418 61.8296 54.9937C67.6767 75.2535 69.3763 81.0572 72.051 85.1111C73.0225 86.5834 74.4332 85.8482 75.3974 85.1905C78.943 81.7624 88.7825 66.6893 100.906 46.6854C105.184 39.5037 105.657 38.3513 107.07 35.5936" stroke="white" stroke-width="4" stroke-linecap="round"/></svg>',
};
